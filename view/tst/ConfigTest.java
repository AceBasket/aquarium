...
public class ConfigTest {
    public static void main(String[] args) throws IOException, ParserException {
        ...
        System.out.println("(ConfigTest) All " + nbTest + " tests passed");
    ...
    void testParserIpAddress() throws IOException, ParserException {
        ...
        assert Parser.parserIP(new File("./tst/testFilesToParse/11.txt")).equals("11.11.11.11") : "testParserIpAddress 11 a échoué";
        // Aucune exception à lever
        assert Parser.parserIP(new File("./tst/testFilesToParse/255.txt")).equals("255.255.255.255") : "testParserIpAddress 255 a échoué";
    ...
    void testParserResources() throws IOException, ParserException {
        ...
        // Aucune exception à lever
        assert Parser.parserResources(new File("./tst/testFilesToParse/0.txt")).equals("blabla") : "testParserResources 0 a échoué";
        // Aucune exception à lever
        assert Parser.parserResources(new File("./tst/testFilesToParse/255.txt")).equals("0toto") : "testParserResources 255 a échoué";
        // Pas de ligne indiquand le dossier de ressources
        try{
