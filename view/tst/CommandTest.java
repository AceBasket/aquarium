...
public class CommandTest {
    public static void main(String[] args) throws IOException, ParserException {
        ...
        System.out.println("(CommandTest) All " + nbTest + " tests passed");
    }
    ...
    void testParserAddFish () throws IOException, ParserException {
        ...
        ArrayList<String> arguments = result.getArgs();
        assert Parser.PossibleResponses.ADDFISH == result.getFunction() : "testAddFish PoissonNain at 61x52, 4x3, RandomWayPoint : fonction a échoué";
        assert arguments.size() == 6 : "testStartFish PoissonNain : args size a échoué";
        assert arguments.contains("PoissonNain") && arguments.indexOf("PoissonNain") == 0 : "testAddFish PoissonNain at 61x52, 4x3, RandomWayPoint : argument a échoué";
        assert arguments.contains("61") && arguments.indexOf("61") == 1 : "testAddFish PoissonNain at 61x52, 4x3, RandomWayPoint : argument a échoué";
        assert arguments.contains("52") && arguments.indexOf("52") == 2 : "testAddFish PoissonNain at 61x52, 4x3, RandomWayPoint : argument a échoué";
        assert arguments.contains("4") && arguments.indexOf("4") == 3 : "testAddFish PoissonNain at 61x52, 4x3, RandomWayPoint : argument a échoué";
        assert arguments.contains("3") && arguments.indexOf("3") == 4 : "testAddFish PoissonNain at 61x52, 4x3, RandomWayPoint : argument a échoué";
        assert arguments.contains("RandomWayPoint") && arguments.indexOf("RandomWayPoint") == 5 : "testAddFish PoissonNain at 61x52, 4x3, RandomWayPoint : argument a échoué";

        add = "addFish Nain at 61x52, 4x3, RandomWayPoint";
        try {
            Parser.parse(add);
        } catch (ParserException e) {
            assert e.getMessage().equals("The fish name is not Poisson*") : "testAddFish Nain at 61x52, 4x3, RandomWayPoint : exception a echoué";
        }
        ...
        try {
            ...
            assert e.getMessage().equals("Invalid Argument Format") : "testAddFish PoissonNain at ax52, 4x3, RandomWayPoint : exception a echoué";
        }
        ...
        try {
            ...
            assert e.getMessage().equals("Invalid Argument Format") : "testAddFish PoissonNain at 61xb, 4x3, RandomWayPoint : exception a echoué";
        }
        ...
        try {
            ...
            assert e.getMessage().equals("Invalid Argument Format") : "testAddFish PoissonNain at 61x52, cx3, RandomWayPoint : exception a echoué";
        }
        ...
        try {
            ...
            assert e.getMessage().equals("Invalid Argument Format") : "testAddFish PoissonNain at 61x52, 4xd, RandomWayPoint : exception a echoué";
        }
        ...
        try {
            ...
            assert e.getMessage().equals("There is not the right number of argument after addFish") : "testAddFish PoissonNain : exception a echoué";
        }
        ...
        try {
            ...
            assert e.getMessage().equals("There is not the right number of argument after addFish") : "testAddFish PoissonNain at 61x52, 4x3, WayPoint, Random : exception a echoué";
        }
    }
    ...
    void testParserStatus () throws IOException, ParserException {
        ...
        arguments = result.getArgs();
        assert Parser.PossibleResponses.STATUS == result.getFunction() : "testStatus status aquarium : fonction a échoué";
